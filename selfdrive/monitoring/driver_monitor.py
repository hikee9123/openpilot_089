...
class DRIVER_MONITOR_SETTINGS():
  def __init__(self, TICI=TICI, DT_DMON=DT_DMON):
    ...
    self._PARTIAL_FACE_THRESHOLD = 0.5 # 0.765 if TICI else 0.455
    self._EYE_THRESHOLD = 0.5 # 0.25 if TICI else 0.45  # 0.57
    self._SG_THRESHOLD = 0.5 # 0.83
    self._BLINK_THRESHOLD = 0.5 #  0.62 if TICI else 0.35 # 0.68
    self._BLINK_THRESHOLD_SLACK = 0.65 # 0.82 if TICI else 0.88
    self._BLINK_THRESHOLD_STRICT = 0.5 # 0.62 if TICI else 0.68
    self._PITCH_WEIGHT = 1.35 # 1.175 if TICI else 1.35  # pitch matters a lot more
    self._POSESTD_THRESHOLD = 0.14 # 0.2 if TICI else 0.175
    self._E2E_POSE_THRESHOLD = 0.9 # 0.95 if TICI else 0.9
    self._E2E_EYES_THRESHOLD = 0.75 # 0.45  # 0.75

    self._METRIC_THRESHOLD = 0.4 # 0.55 if TICI else 0.48
    self._METRIC_THRESHOLD_SLACK = 0.55 # 0.75 if TICI else 0.66
    self._METRIC_THRESHOLD_STRICT = 0.4 # 0.55 if TICI else 0.48
